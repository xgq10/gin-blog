...
func GetArticles(c *gin.Context) {
	...
	if !valid.HasErrors() {
		code = e.SUCCESS
		data["lists"] = models.GetArticles(pagination.GetPage(c), setting.AppSetting.PageSize, maps)
...
func AddArticle(c *gin.Context) {
	...
	valid.Max(coverImageUrl, 100, "cover_image_url").Message("封面图片最长为100字符")
...
func EditArticle(c *gin.Context) {
	...
	valid.Required(coverImageUrl, "cover_image_url").Message("封面图片不能为空")
	valid.MaxSize(coverImageUrl, 100, "cover_image_url").Message("封面图片最长为100字符")
